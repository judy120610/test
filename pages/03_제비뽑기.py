...
if st.button("제비 새로 만들기"):
    ...
    html_code = f"""
    <style>
        .container {{ display: flex; flex-wrap: wrap; gap: 10px; background: #fff; padding: 20px; border-radius: 15px; justify-content: center; perspective: 1000px; }}
        ...
        .front {{ background: #FFD1DC; color: white; font-size: 24px; }}
